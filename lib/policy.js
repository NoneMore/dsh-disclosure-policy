...
export const DISCLOSURE_POLICY_TEXT = 'During long autonomous work, use disclose_progress for brief supervisor checkpoints and continue unless blocked.';
/**
...
export const DISCLOSURE_REMINDER_TEXT = '[disclosure] Call disclose_progress with a brief done/next/approach checkpoint, then continue unless blocked.';
export const DISCLOSURE_REPEAT_TEXT = 'Repeat reminder: no disclose_progress call has been observed in this interval.';
