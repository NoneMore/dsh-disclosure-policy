 ...
 */
export const DISCLOSURE_TOOL_DESCRIPTION = 'Progress checkpoint: report done, next, approach. If work remains, call alongside the next work tool(s).';
/**
 ...
 */
export const DISCLOSURE_REMINDER_TEXT = '[disclosure] Call disclose_progress now; if work remains, batch it with the next work tool(s).';
