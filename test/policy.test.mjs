...
test('the standing policy covers the material disclosure moments', () => {
  ...
  assert.match(DISCLOSURE_POLICY_TEXT, /progress checkpoint, not a turn boundary/i)
  assert.match(DISCLOSURE_POLICY_TEXT, /do not end the turn merely to disclose/i)
  assert.match(DISCLOSURE_POLICY_TEXT, /same message/i)
...
test('the reminder asks for brief disclosure and makes no claim or threat', () => {
  ...
  assert.match(DISCLOSURE_REMINDER_TEXT, /progress checkpoint, not a turn boundary/i)
  assert.match(DISCLOSURE_REMINDER_TEXT, /same assistant message/i)
  assert.match(DISCLOSURE_REMINDER_TEXT, /do not end the turn merely/i)
